...
1. Replace all references to "naomi_api" with your own project name.
2. Rename directories or packages named "naomi_api" to match your project's structure.
...
e.g: `cat naomi_api/VERSION` will get the project version without harming
